define(['backbone'], function(Backbone) {
  ...
  var TopTracksView = Backbone.View.extend({
    tagName: 'div',
    id: 'top_tracks',
    renderTrack: function(model) {
    ...
    render: function() {
      // El método `render` itera a través de todos los elementos de la colección y ejecuta el método `renderTrack` por cada elemento.
